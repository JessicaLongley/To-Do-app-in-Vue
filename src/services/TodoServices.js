...
var baseurl = ""; //where will i try to axxess
if (process.env.NODE_ENV === "development") { //if the process enviroment is development
  baseurl = "http://localhost/todoapi/";
} else {
  baseurl = "/todoapi/"; //this will work in amazon world
}
...
//a bunch of functions. This is the set up code for ajax requests
export default { 
  getLists() {
